  ...
  return (
    <div>
      ...
      <section>
        <h3>Game Updates</h3>
        <p>
          I added WinBox component to the 1990s interface. It is very flexible
          for showcasing the game content.Available functions in this interface:
          1) open windows by clicking the buttons on top right corner, 2) read
          content in each window, including working on code in the dashboard
          window and browsing through calendar, and 3) after turning the
          calendar from 1990 to 1989, the interface will change to CTR mode.{" "}
        </p>
        <p>
          I also name my game as &quot;Bazaar.log&quot;. This name comes from
          the book title, <i>The Cathedral and The Bazaar</i>, in which
          &quot;Bazaar&quot; refers to open-source environment. The
          &quot;.log&quot; might remind the viewer of the type of file that
          records events in a computer. &quot;Bazaar.log&quot;nicely summarizes
          the theme of my game and its history-based story.
        </p>
        <Link
          href="https://bazaar-log.vercel.app/"
          className="external-link-for-blog col-span-1 lg:col-span-3"
