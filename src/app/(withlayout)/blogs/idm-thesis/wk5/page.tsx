  ...
  return (
    <div>
      ...
      <section>
        ...
        <p>
          This week during the Science Fair Demo, I received valuable feedback
          from professors and peers. Below are my reflections on my work so far.
        </p>
        <ul className="list-decimal ml-4">
          <li>
            The game content can be more substantial, containing important or
            interesting historical moments and events that push the Internet and
            open-source ecosystem forward. The gaming elements can conform with
            historical styles as well, like grey UI for Web 1.0 era and random
            pop-up windows for Web 2.0 era in game.
          </li>
          <li>
            The era progression doesn&apos;t have to be time-related -- it can
            also be event-driven. Also, instead of directly printing era name on
            the screen, my new storyline highlights trends and characteristics
            of each era in order to emphasize the progression.
          </li>
          <li>
            During the past two weeks, I realized that incremental game might
            not be the ideal way to showcase my idea. This is because the
            history of the Internet and open source is messy, and the success of
            an open-source project cannot be simplified to a single number.
            Therefore, to increase the information capacity of my game (and also
            attract users), I need to change my UI and game mechanism. I will
            further illustrate my ideas in the next section.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          combination of incremental elements and a visual novel. Below is my
          storyboard (work in progress). Please visit my{" "}
          <Link
            href="https://miro.com/app/board/uXjVIXV_i8U=/?share_link_id=831427984493"
            className="external-link-for-blog col-span-1 lg:col-span-3"
            target="_blank"
        ...
        <p>
          ...
          will also include more storytelling elements like retrospective UI,
          text and image content in news, notebook, calendar, and LAN
      ...
      <section>
        ...
        <p>
          Here is an interesting reasearch presented at CERN 2019 WorldWideWeb
          Rebuild:
        </p>
      ...
      <section>
        ...
        <ul className="list-disc ml-4">
          <li>
            Refine storyboard: clarify protagonist&apos;s emotion arc, and think
            about what historical events and details to include.
          </li>
