  ...
  return (
    <div>
      ...
      <section>
        ...
        <p>
          From the demo day playtesting, I observed that instead of being from
          easy to difficult like most games&apos; progression, my game starts
          from a difficult level, especially for players who never program in an
          CLI environment before. Therefore, players lacked the motivation to
          explore each function or play further.
        </p>
        <p>
          ...
          players to read through for instructions, and 2) designing an in-game
          tutorial to guide players through each function. Below are my
          progresses so far.
        </p>
        <h4>Player Manual</h4>
      ...
      <section>
        ...
        <ul className="list-disc ml-4">
          <li>Finish UI layout and content design for each stage.</li>
          <li>
            Brainstorm at least 5 easter eggs at each stage, and think about how
            to implement them.
          </li>
        </ul>
      </section>
