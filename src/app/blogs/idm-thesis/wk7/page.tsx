      ...
      <main className="col-span-1 lg:col-span-3 p-4 mb-8">
        <div>
          ...
          <section>
            ...
            <div className="relative w-full pb-[56.25%] mb-4"><iframe
              width="full"
              height="auto"
          ...
          <section>
            ...
            <ul className="list-disc ml-4">
              <li>
                Players were amazed at the transition from stage 1 (1970 - 1990)
                to stage 2 (1991 - 2005), though some missed the top right
                buttons available in stage 2 and asked if they had broken my
                game.
              </li>
              <li>
                My game succeeded in making players curious about what happened
                to open source and the Internet between 1970 and 1990.
              </li>
            </ul>
            ...
            <ul className="list-disc ml-4">
              <li>
                ...
                gaming experience. Because CLI is not intuitive, many players
                asked &quot;how to play&quot; or &quot;what should I do
                now&quot; while playing.
              </li>
              <li>
                Players felt that the stage 1 was too long / required too many
                actions to level up to the stage 2. Some reported that they
                thought the CRT screen would be the UI throughout the game.
              </li>
              <li>
                Players missed content or functions along the way. After
                learning about the game narrative, they reported that they
                didn&apos;t want to miss any of the content because they are
                interesting and relevant to the game story.
              </li>
              <li></li>
            </ul>
          </section>
            ...
            <ul className="list-disc ml-4">
              <li>
                ...
                <ul className="list-circle ml-4">
                  <li>
                    At the beginning of the game, introduce the game protagonist
                    (a computer researcher at a university lab) that aligns with
          ...
          <section>
            ...
            <ul className="list-disc ml-4">
              <li>
                Make the initial gameplay easier, with more guidance and rewards
                to encourage players to keep on playing.
              </li>
              <li>
                Combine small rewards and big rewards. Currently, the UI change
                triggered by turning calendar is a big and interesting reward,
                but players tend to quit before that. Therefore, include more
                small changes and rewards before the big change. For example, in
                game stage 1, there can be small errors, viruses, and even ASCII
                art triggered by specific player actions. Bezel style or text
                color change might also be effective, as the CRT screen is so
                simple that any small changes will be observed.
              </li>
              <li>
                Currently, the CRT screen and interactions are developed in a
                realistic way. However, one objective of my game is to invite a
                wide audience to experience the game and understand the story.
                Therefore, I decide to retain the retro-aesthetics but carefully
                design user experience in a way that modern audience without CLI
